    ...
    <div class="profile-settings">
        ...
        <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" id="profile_picture" name="profile_picture" accept="image/*" onchange="previewImage(event)" style="color:#23130B">
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('user.home') }}" class="btn-cancel" style="text-decoration: none; display: inline-block;">Cancel</a>
            </div>
        </form>
    </div>
